...
unsigned short sum_AVX(long size, unsigned short *a) {
    ...
    for (int i = 0; i < size; i += 16) {
      partial_sums = _mm256_add_epi16(partial_sums, _mm256_loadu_si256((__m256i*) &a[i]) ); 
    ...
    return partial_sum_array[0] + partial_sum_array[1] + partial_sum_array[2] + partial_sum_array[3] + partial_sum_array[4] + partial_sum_array[5] + partial_sum_array[6] + partial_sum_array[7] + partial_sum_array[8] + partial_sum_array[9] + partial_sum_array[10] + partial_sum_array[11] + partial_sum_array[12] + partial_sum_array[13] + partial_sum_array[14] + partial_sum_array[15]; 
}
...
function_info functions[] = {
    ...
    // add entries here!
    {sum_AVX, "sum but with the AVX instructions"}, 
    {NULL, NULL},
};
