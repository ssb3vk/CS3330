...
stall_D = loadUse; 
bubble_D = conditionsMet;
bubble_E = conditionsMet || loadUse || retBubble;
bubble_M = retBubble; 
bubble_W = retBubble; 
...
d_dstM = [
	d_icode in {MRMOVQ, POPQ, PUSHQ, RET} : D_rA; #used for 
	1 : REG_NONE; 
]; 
...
e_valA = [
	...
	E_srcA == M_dstE : M_valE; # CAn i do this to account for irmovq follwed by rmmovq
	1 : E_valA;
];
